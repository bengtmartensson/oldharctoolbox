...
public class macro_engine {
    ...
    public macro_engine(String filename, home the_home, int debug) throws IOException, SAXParseException {
        this.the_home = the_home;
        db = new debugargs(debug);
        doc = harcutils.open_xmlfile(filename);
    }

    public macro_engine(home hm) throws IOException,SAXParseException {
        this(harcprops.get_instance().get_macrofilename(), hm, 0);
    }

    public void load(String filename) throws IOException, SAXParseException {
        doc = harcutils.open_xmlfile(filename);
    }
    ...
    public String[] get_macros(boolean include_description) {
        return get_macros(doc.getElementsByTagName("macro"), include_description);
    }
    ...
    public String[] get_folders() {
        return get_folders(doc.getDocumentElement().getAttribute("name"), 0);
    }
